...
public class Class2_result_guardian_site extends AppCompatActivity {
  //  private static final String JSON_URL = "http://10.0.2.2:8081/Software_project/get_class2_result.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class2_result_guardian_site);
        ...
        if(value.equalsIgnoreCase("Class 2")){
            ...
            Intent ii=new Intent(getApplicationContext(),Class3_result_guardian_site.class);
            ii.putExtra("val2",value);
            startActivity(ii);
        }
...
//initializing the productlist
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config_url.getClass2result, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Class2_result_guardian_site.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
